...
from osbenchmark.database.clients.milvus.runners import (
...
class MilvusBulkVectorDataSetTests(TestCase):
    ...
    @mock.patch("osbenchmark.database.clients.milvus.runners.parse_vector_body")
    @mock.patch("osbenchmark.database.clients.milvus.runners.request_context_holder")
    @run_async
...
class MilvusVectorSearchTests(TestCase):
    ...
    @mock.patch("osbenchmark.database.clients.milvus.runners.convert_milvus_search_response")
    @mock.patch("osbenchmark.database.clients.milvus.runners.build_search_params")
    @mock.patch("osbenchmark.database.clients.milvus.runners.request_context_holder")
    @run_async
    ...
    @mock.patch("osbenchmark.database.clients.milvus.runners.calculate_topk_recall")
    @mock.patch("osbenchmark.database.clients.milvus.runners.convert_milvus_search_response")
    @mock.patch("osbenchmark.database.clients.milvus.runners.build_search_params")
    @mock.patch("osbenchmark.database.clients.milvus.runners.request_context_holder")
    @run_async
...
class MilvusCreateIndexTests(TestCase):
    ...
    @mock.patch("osbenchmark.database.clients.milvus.runners.build_collection_schema")
    @mock.patch("osbenchmark.database.clients.milvus.runners.request_context_holder")
    @run_async
